...
final class GalleryService {
    ...
    func obtenerGaleria(fecha: String, id: Int, completion: @escaping (Result<GaleriaPayload, Error>) -> Void) {
        let urlString = "\(API.baseURL)galerias/\(fecha)/\(id)"
        ...
        URLSession.shared.dataTask(with: request) { data, response, error in
            DispatchQueue.main.async {
                ...
                do {
                    ...
                    let responseData = try decoder.decode(GaleriaResponse.self, from: data)
